...
```
Figure 9.1: Participation in Basic Needs Programs
...
rm(p1,p2)
```
Figure 9.2: CalFresh EBT: Application & Feeding
...
```
Figure 9.3: Monthly Allowance from CalFresh
...
rm(p1,p2)
```
Figure 9.4: Enough Monthly Allowance and Time of Exhaustion 
...
plot_likert(questions[11:22],
            ...
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
Figure 9.5: Perceived Benefits of CalFresh
...
plot_likert(questions[11:22],
            ...
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
Figure 9.6: Perceived Impact of Campus Food Pantry
...
```
Figure 9.7: Food Pantry Use Frequency
...
plot_likert(questions,
            ...
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
Figure 9.8: Perceived Impact of Restaurant Meal Program (RMP)
...
plot_likert(questions,
            ...
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
Figure 9.9: Perceived Impact of Medical


### Reasons Not Using Medical
**What are the reasons you do not have MediCal or have never used MediCal? (Select all that apply).**
```{r}
question <- "no_medical"
...
plot_likert(questions,
            ...
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
Figure 9.10: Perceived Impact of Emergency Housing Services (EHS)
