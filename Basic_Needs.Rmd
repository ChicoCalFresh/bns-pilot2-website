...
```{r}
# Create variable for if student has used CalFresh in college
calfresh.used <- data.frame(q46_1=bns$q46_1) %>% mutate(college=ifelse(grepl("past as a college student|use as a college student", q46_1), 1, 0),
                                                        college=ifelse(is.na(q46_1), NA, college)) %>% select(-q46_1)
```
...
**How much money do you receive from CalFresh each month?**
```{r, fig.width=7}
...
### Food Pantry Use
**How often do you normally use the food pantry or if you are not currently using it, how often did you use it?**
```{r}
