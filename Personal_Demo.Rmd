...
plot_grpfrq(tmp$school, tmp$hispanic, wrap.labels = 25, geom.colors = campus.colors[c(2,1)], legend.title = "Identifies") + xlab("") + ylab("Frequency") + theme(legend.position="top")
```
