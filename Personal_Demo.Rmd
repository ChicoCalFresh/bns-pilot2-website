...
```
Figure 1. Student Age Distribution
...
```
Figure 2: Student Gender Identity
...
```
Figure 3: Hispanic Origin Identification
...
Table 1. Student Race Identification
```{r}
...
```
Figure 4: Martial Status Identification
...
```
Figure 6: Dependent Age Distribution
...
```
Figure 7: Parents Highest Education
...
```
Figure 8. First Generation College Students
