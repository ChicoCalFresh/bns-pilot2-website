...
plot_xtab(bns$school, bns$q7, margin="row", legend.title = "Gender Identity", axis.titles = c("School", "Campus Percent")) + theme(legend.position="top")
```
...
plot_xtab(tmp$school, tmp$hispanic, margin="row", legend.title = "Hispanic Origin", axis.titles = c("School", "Campus Percent")) + theme(legend.position="top")
```
...
plot_xtab(bns$school, bns$q13, margin="row", legend.title = "Parents Education", axis.titles = c("School", "Campus Percent"), coord.flip = TRUE, ylim=c(0,0.8))
```
...
plot_xtab(tmp$school, tmp$firstgen, margin="row", legend.title = "Status", axis.titles = c("School", "Campus Percent")) + theme(legend.position="top")
```
