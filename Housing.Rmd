...
```{r}
cnames <- c('Current Housing Situation', 'Percentage')
...
```{r, fig.height=9}
p1 <- plot_frq(bns$q34, wrap.title=45, title = 'How many times have you been unsure of where you were going to sleep at night?') + xlab('')
p2 <- plot_frq(bns$q35, wrap.labels =15, title = 'How many times have you moved?') + xlab('')
