...
```
Figure 7.1: Impact of COVID on Housing
...
```
Figure 7.2: Living Near Enrolled College
...
rm(p1,p2)
```
Figure 7.3: Unsure of Sleeping and Times Moved
...
```
Figure 7.4: Unstable Housing Identification
