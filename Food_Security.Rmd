...
```{r, fig.width=8}
plt1 <- plot_frq(bns$q67, ylim=c(0,300), title="Did you cut/skip any meals") +xlab('')
...
```{r, fig.width=8}
plt1 <- plot_frq(bns$q72, title="Did you not eat for a whole day", wrap.title = 20) +xlab('')
