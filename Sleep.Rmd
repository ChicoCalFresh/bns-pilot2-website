...
## Academic Year
**On average, during the academic year, how many hours of sleep do you get in a typical 24-hour period?** *Note that for the week days we have `r print_n_reporting("q84")` And for the weekends we have `r print_n_reporting("q85")`*
...
```
`r fig.cap(page.num, "Sleep Deprivation Causes")`
...
```
`r fig.cap(page.num, "Frequency of Tired at Work/School")`
...
```
`r fig.cap(page.num, "Fallen Asleep in Class (Past Year)")`
