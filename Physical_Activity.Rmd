...
# colnames(tmp) <- as.character(0:7)
# rownames(tmp) <- c("Moderate Exercise", "Strength Training", "Vigorous Training")
# 
# tmp %>% kable() %>% kable_styling(bootstrap_options = "striped")

desc_vals("moderate_exercise_past_week")
```
...
### Strength Training
```{r, results='asis'}
desc_vals("strength_training_past_week")
```
...
### Vigorous Exercise
```{r, results='asis'}
desc_vals("vigorous_exercise_past_week")
```
