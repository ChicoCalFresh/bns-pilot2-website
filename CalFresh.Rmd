...
```
`r fig.cap(page.num, "Meals Per Week from Meal Plan")`
...
```{r}
plot_frq(bns$calfresh_eligible, title = "Most Likely to be CalFresh Eligible") + xlab('CalFresh Eligible')
```
`r fig.cap(page.num, "Eligible for CalFresh")`
