...
```
Figure 8.1: Meals Per Week from Meal Plan
...
rm(tmp)
```
Table 8.1: Housing Size vs. Income (CalFresh Eligibility)
...
## CalFresh Eligible
**This variable was created under the following assumptions `r print_n_reporting("calfresh_eligible")`**
...
```
Figure 8.2: Eligible for CalFresh
