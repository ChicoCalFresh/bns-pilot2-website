...
- The website is a tool to present exploratory data analysis results to the public, for both general survey results and campus breakdown.
- Each tab on the header of the website corresponds to a set of questions within the Basic Needs Survey. Some of these tabs have a drop down menu to group questions even further as well.
- Each page on the website contains a brief paragraph at the top which explains a general overview of questions captured on the page.
...
- Campus breakdowns were added within pages below the figures of the general survey data. They're hidden drop down menu's like the one below:
