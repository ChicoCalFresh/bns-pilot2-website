...
## Transfer Students
**I identify as a transfer student:**
```{r, fig.width=7.2}
plot_grpfrq(bns$q14_1, bns$school, wrap.legend.labels = 30, ylim=c(0,83), geom.colors = campus.colors, legend.title = "", show.prc = FALSE) + 
  xlab('') + theme(legend.position="top")
```
