...
plot_grpfrq(bns$school, bns$q16, wrap.labels = 25, wrap.legend.labels = 20, geom.colors = RColorBrewer::brewer.pal(5, "Spectral"), 
            legend.title = "", show.prc = FALSE) + 
  xlab('') + theme(legend.position="top")
```
Figure 4.1: Major Declaration by Campus
...
plot_grpfrq(bns$school, bns$q17, wrap.labels = 25, geom.colors = RColorBrewer::brewer.pal(5, "Spectral"), legend.title = "", show.prc = FALSE) + 
  xlab('') + theme(legend.position="top")
```
Figure 4.2: Approximate GPA Ranges by Campus
...
```
Figure 4.3: Academic Unit Enrollments by Campus
...
plot_grpfrq(bns$school, bns$q14_1, wrap.labels = 25, ylim=c(0,83), geom.colors = campus.colors[c(2,1)], legend.title = "", show.prc = FALSE) + 
  xlab('') + theme(legend.position="top")
```
Figure 4.4: Transfer Student Identification by Campus
