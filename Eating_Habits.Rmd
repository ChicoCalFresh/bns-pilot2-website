...
plot_likert(questions,
            ...
            values = "sum.outside",
            catcount = 5,
            geom.colors = sentiment.color.pal.5,
...
### Sugar/Energy Drinks
**How many ounces of regular soda/cola/pop, sports drink, or energy drinks do you consume each day?**
```{r, fig.width=7}
...
### Alcohol Consumption
**How often do you consume at least one serving of alcohol? If consumed, how many servings of alcohol do you consume when you drink alcohol?**
...
plot_likert(questions,
            ...
            values = "sum.outside",
            catcount = 6,
            geom.colors = sentiment.color.pal.6,
            show.prc.sign = TRUE, reverse.scale = TRUE) + theme_bw() + theme(legend.position = "top")
```
