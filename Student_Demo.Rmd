...
plot_xtab(bns$school, bns$q16, margin="row", legend.title = "Major", axis.titles = c("School", "Campus Percent"), coord.flip = TRUE, ylim=c(0,0.7))
```
...
```{r, fig.height=6, fig.width=8}
plot_xtab(bns$school, bns$q17, margin="row", legend.title = "GPA", axis.titles = c("School", "Campus Percent"), coord.flip = TRUE, ylim=c(0,0.61))
```
...
```{r, fig.width=6.5}
plot_xtab(bns$school, bns$q14_1, margin="row", legend.title = "Transfer Student", axis.titles = c("School", "Campus Percent")) + theme(legend.position="top")
```
